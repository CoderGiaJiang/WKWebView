...
callNativeFunction: function(functionString, params, callBack) {
    ...
    if (!callBack) {
        ...
        window.webkit.messageHandlers.jsVoidMethod.postMessage(message);
        ...
        if (!Event._listeners[callBackName]) {
            Event.addEvent(callBackName,
                           function(data) {
                           callBack(data);
                           });
        }
        window.webkit.messageHandlers.jsCallBackMethod.postMessage(message);
    }
