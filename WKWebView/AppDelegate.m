...
//  WKWebView
//
//  Created by GiaJiang on 2017/8/25.
...
//    NSString *url = [NSString stringWithFormat:@"file://%@",[[NSBundle mainBundle] pathForResource:@"Test" ofType:@"html"]];
    BaseWKWebViewController *jkVC = [BaseWKWebViewController instanceWithURL:@"http://static.fallchat.com/demo/Test.html"];
    //     http://static.fallchat.com/demo/Test.html"
